...
final class Renderer {
    ...
    private let maxPoints = 25000
    // Number of sample points on the grid
    private let numGridPoints = 12000
    // Particle's size in pixels
    private let particleSize: Float = 40
    ...
    func savePointsToFile() -> ([SIMD3<Float>], [SIMD3<Int>]) {
        var pointCloudPos : [SIMD3<Float>] = []
        var pointCloudColor : [SIMD3<Int>] = []
        
        guard !self.isSavingFile else { return (pointCloudPos, pointCloudColor) }
        ...
        for i in 0..<currentPointCount {
            ...
            pointCloudPos.append(SIMD3<Float>(point.position.x, point.position.y, point.position.z))
            pointCloudColor.append(SIMD3<Int>(Int(red), Int(green), Int(blue)))
        ...
        return (pointCloudPos, pointCloudColor)
    }
}
